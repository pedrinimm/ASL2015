...
public class GetUser {
		...
		public static final String callableFunction = "{call get_user_id(?)}";
		
		
		public synchronized static String execute_query(Connection con, String user_name){
			...
			try{
				...
				if(!con.isClosed()){
					...
					callFunction.setString(1, user_name);
