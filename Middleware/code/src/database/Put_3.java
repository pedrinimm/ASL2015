...
//			for testing the databse connection
			...
			public synchronized static String execute_query(Connection con, Message newMessage, String queueName){
...
//						System.out.println("conencted!!");
						...
						callFunction.setString(2, newMessage.message);
						callFunction.setString(3, newMessage.sender);
						callFunction.setString(4, newMessage.reciever);
						callFunction.setString(5, newMessage.messageID.toString());
						callFunction.setString(6, newMessage.timestamp.toString());
						callFunction.setString(1, queueName);
